...
osg.CullFace.prototype = {
    ...
    getType: function() { return this.attributeType;},
    getTypeMember: function() { return this.attributeType;},
    apply: function(state) { gl.cullFace(gl[this.mode]);}
};
        ...
        if (this.attachments.length > 0) {
            if (this.fbo === undefined) {
                ...
                for (var i = 0, l = this.attachments.length; i < l; ++i) {
                    ...
                    gl.framebufferTexture2D(gl.FRAMEBUFFER, this.attachments[i].attachment, texture.target, texture.textureObject, this.attachments[i].level);
