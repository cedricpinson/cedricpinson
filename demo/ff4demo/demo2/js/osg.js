...
osg.BlendFunc.prototype = {
    ...
    getType: function() { return this.attributeType;},
    getTypeMember: function() { return this.attributeType;},
    apply: function(state) { gl.blendFunc(this.sourceFactor, this.destinationFactor); }
};
...
osg.RenderBin.prototype = {
    ...
    drawImplementationNew: function(state, previousRenderLeaf) {
        ...
        for (var key in this.renderBin) {
            if (key < 0 ) {
                this.renderBin[key].drawImplementationNew(state, previousRenderLeaf);
            }
        }
        
        // draw leafs
        this.drawLeafs(state, previousRenderLeaf);
...
osg.RenderStage.prototype = osg.objectInehrit(osg.RenderBin.prototype, {
    reset: function() { this.superObject.reset.call(this); },
    ...
    drawInner: function(state, previousRenderLeaf, doCopyTexture) {},
    ...
    drawImplementation: function(state, previousRenderLeaf) {
        ...
        this.superObject.drawImplementationNew.call(this, state, previousRenderLeaf);
        //debugger;
        //state.apply();
    }
...
osg.CullVisitorNew.prototype = osg.objectInehrit(osg.NodeVisitor.prototype, {
    ...
    applyCamera: function( camera ) {
        ...
        if (camera.getRenderOrder() === osg.Camera.NESTED_RENDER) {
            ...
            // not tested
            debugger;
            var previous_stage = getCurrentRenderBin().getStage();
